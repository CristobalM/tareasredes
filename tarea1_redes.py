...
#def config_file_procces(archivo): #para sacar info de hostname, y resolver
#def fiter_file_procces(archivo): #tener en memoria los filtros
...
def run_server():
    ...
    while True:
        ...
        copy_dns_parser_input= copy.deepcopy(dns_parser_input) #variable copiada para trabajar con ella
        ...
        if cache.is_saved(user_query):
            ...
            host_name = copy.deepcopy(dns_parser_input.questions_records.pop())
