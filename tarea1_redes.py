...
class RRParser:
    ...
    def process_msg(self, send_data):
        ...
        if self.dns_type=="0001" or self.dns_type=="001c": #para analizar ipv4, ipv6
            ...
            respuestas.append([self.dns_name,self.dns_type,self.dns_class,self.dns_ttl,self.dns_rdlength,self.dns_answer])
        if self.dns_type=="000f": #si es mail
            ...
            respuestas.append([self.dns_name,self.dns_type,self.dns_class,self.dns_ttl,self.dns_rdlength,self.dns_preference,self.dns_exchange])
